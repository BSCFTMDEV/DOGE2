...
const VAULTABI = [
  {
    inputs: [
      ...
      {
        internalType: 'contract MechsEVM2',
        name: '_token',
        type: 'address'
      }
    ],
    ...
    contract.totalSupply().then(result => {
      for (let i = 0; i < result; i++) {
        ...
        const getUri = Uri.then(value => {
          const cleanUri = value.replace('ipfs://', 'https://ipfs.io/ipfs/')
            ...
            <Grid >
              <a>
                <Card isHoverable key={i} css={{ mw: '200px', marginRight: '$1' }} variant="bordered">
                  ...
                  <Card.Body sm key={i}>
                  <h3 style={{ color: '#9D00FF', fontFamily: 'SF Pro Display' }}>DogeBox Nft's</h3>
                    ...
                    />
                    <Button size="sm" color="gradient" onPress={executeRelist} style={{ fontSize: '20px' }}>List for Sale</Button>
